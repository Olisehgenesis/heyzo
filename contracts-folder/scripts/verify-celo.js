...
async function main() {
  ...
  if (!contractAddress) {
    ...
    console.error("Usage: node scripts/verify-celo.js <contract_address> [network]");
    console.error("Example: node scripts/verify-celo.js 0x8edf0a82bfeaf29b16b9131b5ce7274f3e994273 celo");
    process.exit(1);
  }
  ...
  try {
    ...
    console.log(`API Key: ${celoscanApiKey.substring(0, 8)}...`);
